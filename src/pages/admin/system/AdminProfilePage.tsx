...
export default function AdminProfilePage() {
  ...
  const infoSections = [
    ...
    },
    {
      ...
      color: '#3b82f6',
      fields: [
        { label: '所属单位', value: u.company, icon: Building2 },
        { label: '数据范围', value: u.region, icon: MapPin },
      ],
    },
  ]
  ...
  return (
    <div className="flex h-full flex-col gap-5">
      ...
      <div className="grid min-h-0 flex-1 auto-rows-min grid-cols-2 gap-5">
