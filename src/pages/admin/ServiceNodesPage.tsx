        ...
        <Table className="text-sm">
          <TableHeader className="[&_tr]:border-b [&_tr]:border-[#e9ebec]">
            <TableRow className="border-0 hover:bg-transparent">
              <TableHead className="h-10 rounded-tl-lg bg-[rgba(233,235,236,0.4)] px-4 text-xs font-semibold text-[#323232]">节点名称</TableHead>
            ...
            {pageRows.map((node, i) => {
              ...
              return (
                <TableRow key={node.code} className={cn(
                  ...
                  <TableCell className="px-4 py-3 text-[14px] leading-[22px] text-[#323232]">{node.name}</TableCell>
